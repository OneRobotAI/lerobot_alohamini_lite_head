...
class LeKiwiConfig(RobotConfig):
    ...
    robot_model: str = "alohamini1-head"
...
class LeKiwiClientConfig(RobotConfig):
    ...
    # alohamini1-head   – so-arm-5dof (6 joints per arm, no wrist_yaw) + head_pitch
    # alohamini2-head   – am-follower-6dof (7 joints per arm, includes wrist_yaw) + head_pitch
    # alohamini2pro-head– am-follower-6dof-hd (7 joints per arm, includes wrist_yaw) + head_pitch
    robot_model: str = "alohamini1-head"
