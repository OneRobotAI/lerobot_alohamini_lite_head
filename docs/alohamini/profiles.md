...
|-----------------|--------------|-------------|------------|------------|
| `alohamini1-head` | `so-arm-5dof` | STS3215 ×3 | STS3215 | 84 mm/rev |
| `alohamini2-head` | `am-follower-6dof` | STS3215 ×3 | STS3095 | 131 mm/rev |
| `alohamini2pro-head` | `am-follower-6dof-hd` | STS3250 ×3 | STS3095 | 131 mm/rev |
| `alohamini2lite-head` | `am-follower-6dof-lite` | STS3215 ×3 | STS3215 | 84 mm/rev |
...
| AM-ARM200 Lite | Follower (12V) | `am-follower-6dof-lite` |
