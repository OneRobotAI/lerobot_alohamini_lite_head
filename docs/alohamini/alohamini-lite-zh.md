...
> - `alohamini1-head` — SO-ARM 5-DoF，**17 维状态**（含 head_pitch）
> - `alohamini2-head` / `alohamini2pro-head` / `alohamini2lite-head` — AM-ARM 6-DoF，**19 维状态**（含 head_pitch）
...
其他型号同理，将 `--robot_model` 替换为：`alohamini1-head`、`alohamini2-head`、`alohamini2pro-head`。
...
|---|---|---|---|---|---|---|---|
| `alohamini1-head` | so-arm-5dof | 6（5 关节 + 夹爪） | 全 STS3215 | STS3215 (ID 12) | STS3215 | STS3215 | 84 mm/rev |
| `alohamini2-head` | am-follower-6dof | 7（6 关节 + 夹爪） | 混合 STS3215/STS3095 | STS3215 (ID 12) | STS3215 | STS3095 | 131 mm/rev |
| `alohamini2pro-head` | am-follower-6dof-hd | 7（6 关节 + 夹爪） | 全 STS3250 | STS3215 (ID 12) | STS3250 | STS3095 | 131 mm/rev |
| `alohamini2lite-head` | am-follower-6dof-lite | 7（6 关节 + 夹爪） | 全 STS3215 | STS3215 (ID 12) | STS3215 | STS3215 | 84 mm/rev |
